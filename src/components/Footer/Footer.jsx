        ...
        <div className="row g-5 mb-5 pb-5 border-bottom border-outline-variant">
          ...
          <div className="col-12 col-md-5 d-flex flex-column gap-3">
            <div className="d-flex align-items-center gap-2 mb-2">
              ...
              <span className="text-label-caps text-accent fw-bold" style={{ letterSpacing: '0.15em' }}></span>
            </div>
          ...
          <div className="col-6 col-md-2 d-flex flex-column gap-3">
            ...
            <ul className="list-unstyled d-flex flex-column gap-3 mb-0">
              ...
              <li><a href="#" className="text-body-md text-on-surface-variant text-decoration-none footer-link">Contacts</a></li>
            </ul>
          </div>
          ...
          <div className="col-12 col-md-3 d-flex flex-column gap-3">
            ...
            <ul className="list-unstyled d-flex flex-column gap-3 mb-0">
              <li className="d-flex gap-2 align-items-start">
                ...
                <span className="text-body-md text-on-surface-variant">Saudi Arabia</span>
              </li>
              <li className="d-flex gap-2 align-items-start">
                <span className="text-accent mt-1">
                  <svg width="14" height="14" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <li className="d-flex gap-2 align-items-start">
                ...
                <a href="tel:+966500850270" className="text-body-md text-on-surface-variant text-decoration-none footer-link">+966 500 850 270</a>
              </li>
            </ul>
          </div>
